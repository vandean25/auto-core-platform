...
import { Controller, Post, Body, Param, Get, Res, BadRequestException } from '@nestjs/common';
...
export class PurchaseController {
    ...
    @Post()
    async createPurchaseOrder(@Body() body: { vendorId: string; items: { catalogItemId: string; quantity: number; unitCost: number }[] }) {
