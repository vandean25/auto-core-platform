...
const entityInvalidationMap: Record<
  RealtimeEntityType,
  EntityInvalidationTarget
> = {
  PURCHASE_ORDER: {
...
export function isEntityUpdatedPayload(
  value: unknown,
): value is EntityUpdatedPayload {
