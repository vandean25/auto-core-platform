    ...
    return (
        <div className="w-full max-w-7xl mx-auto p-6 space-y-8">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <div className="lg:col-span-4 h-[350px] border rounded-xl bg-slate-50 flex items-center justify-center text-muted-foreground">
                    Placeholder for Sales Over Time Chart
                </div>
