...
describe('WorkScheduleEditor', () => {
  ...
  it('posts a new schedule version with effective date', async () => {
    ...
    render(
      <WorkScheduleEditor
        ...
        canEdit
        defaultEffectiveFrom='2026-09-01'
      />,
    )
  ...
  it('requires an effective date before creating a new version', async () => {
    setupEditor(true)
    apiMocks.useEmployeeWorkSchedule.mockReturnValue({
