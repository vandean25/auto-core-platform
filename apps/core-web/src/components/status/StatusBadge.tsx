...
const statusClassMap: Record<string, string> = {
  ...
  WAITING_CUSTOMER: 'border-sky-200 bg-sky-100 text-sky-700',
  PAUSED: 'border-purple-200 bg-purple-100 text-purple-700',
  ...
  ON_ORDER: 'border-indigo-200 bg-indigo-100 text-indigo-700',
  RESERVED: 'border-amber-200 bg-amber-100 text-amber-700',
  IN_PREP: 'border-sky-200 bg-sky-100 text-sky-700',
  SOLD: 'border-violet-200 bg-violet-100 text-violet-700',
  RECEIVED: 'border-emerald-200 bg-emerald-100 text-emerald-700',
