...
export type OpenApiAliasChecks = [
  ...
  ExpectTrue<Equal<SalesOrderItem, Schemas['SalesOrderItemResponseDto']>>,
  ExpectTrue<Equal<Invoice, Schemas['InvoiceResponseDto']>>,
  ExpectTrue<Equal<InvoiceItem, Schemas['InvoiceItemResponseDto']>>,
  ExpectTrue<Equal<InvoiceItem['tax_rate'], number>>,
  ExpectTrue<Equal<SalesOrderItem['tax_rate'], number>>,
  ExpectTrue<Equal<RevenueGroup['tax_rate'], number>>,
