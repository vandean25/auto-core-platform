...
VALUES
  ...
  ('inventory_stocks', 'storage_locations', 'tenant_id,site_id,location_id', 'tenant_id,site_id,id', 'RESTRICT', 'CASCADE'),
  ...
  ('invoices', 'legal_entities', 'tenant_id,legal_entity_id', 'tenant_id,id', 'RESTRICT', 'CASCADE'),
  ('invoices', 'sales_orders', 'tenant_id,sales_order_id', 'tenant_id,id', 'RESTRICT', 'CASCADE'),
  ('invoices', 'sites', 'tenant_id,site_id', 'tenant_id,id', 'RESTRICT', 'CASCADE'),
...
WHERE "tenant_id" = current_setting('app.target_tenant_id');
DELETE FROM public."catalog_provider_settings"
WHERE "tenant_id" = current_setting('app.target_tenant_id');
DELETE FROM public."catalog_oem_concern_makes"
WHERE "tenant_id" = current_setting('app.target_tenant_id');
DELETE FROM public."catalog_items"
WHERE "tenant_id" = current_setting('app.target_tenant_id');
DELETE FROM public."attendance_events"
WHERE "tenant_id" = current_setting('app.target_tenant_id');
DELETE FROM public."accounting_exports"
WHERE "tenant_id" = current_setting('app.target_tenant_id');
