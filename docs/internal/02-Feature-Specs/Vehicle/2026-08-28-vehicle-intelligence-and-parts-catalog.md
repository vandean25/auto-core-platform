...
Architecture: [ADR-0021](../../01-ADR/2026-08-28-vehicle-intelligence-catalog-providers.md). Spec + ADR are the implementation source of truth for the locks below. ADR-0021 is **Accepted** (2026-08-28). M1 is **Done** (AUT-229–AUT-235). Implement M2 then M3 from the Linear issues in Linear Tracking; do not start M4 or Nest/React outside those issues. M3 is blocked by remaining M2 schema/API issues (AUT-237–AUT-239).
