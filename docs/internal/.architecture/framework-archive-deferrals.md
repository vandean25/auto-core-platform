# Archived framework-meta deferrals

**Archived**: 2026-08-18 (AUT-151 / DOCS-3)
**Status**: Not product work. Do not treat these as a backlog.

These entries were copied into `deferrals.md` from the 2025 pragmatic architecture framework (Phase 2B / 3B / 4B documentation tasks and December 2025 README "documentation improvements"). None had a product owner. Monthly and quarterly review of that list was not happening.

Live product deferrals (vehicle stock phases B / C / D) live in [`deferrals.md`](deferrals.md).

Do not re-open items here unless someone owns the work and a real trigger is met.
