...
| Cloud Run                                               | `DATABASE_URL` + `DATABASE_URL_POOLED`                            | `cloudbuild.yaml` maps `_DATABASE_POOLED_SECRET` to `acp-core-api-database-url-pooled`; deploy to apply on Cloud Run. |
